   ...
   JSROOT.GEO.getNodeProperties = function(kind, node, visible) {
      ...
      if (kind === 1) {
         ...
         if (visible) {
            ...
            prop.material = new THREE.MeshPhongMaterial( { transparent: _transparent, shininess:100,//metalness: 0.7, 
                           opacity: _opacity, wireframe: false, color: prop.fillcolor, //roughness: 0.65,
